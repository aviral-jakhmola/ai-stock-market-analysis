                ...
                {loading ? (
                    ...
                    <>
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mt-5">
                            <DashboardCard title="Current Price" value={latest ? formatINR(latest.close) : "--"} trend={trend} />
                            <DashboardCard title="High" value={latest ? formatINR(latest.high) : "--"} trend={trend} />
                            <DashboardCard title="Low" value={latest ? formatINR(latest.low) : "--"} trend={trend} />
                            <DashboardCard title="Volume" value={latest ? latest.volume.toLocaleString() : "--"} />
                        </div>
